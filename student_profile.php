...
<input type="text" class="form-control" id="classc" name="classc">
</div>
...
<input type="text" class="form-control" id="subjects" name="subjects">
  ...
  <br>
  <input class="form-check-input" name="twoseessos" type="checkbox" value="2 seessos/classes in a week" id="flexCheckDefault">
  <label class="form-check-label" for="flexCheckDefault">
  2 seessos/classes in a week
  </label>
  &nbsp;
  &nbsp;
  &nbsp;
  &nbsp;
  <input class="form-check-input" type="checkbox" name="threseessos" value="3 seessos/classes in a week" id="flexCheckDefault">
  <label class="form-check-label" for="flexCheckDefault">
  3 seessos/classes in a week
  </label>
  <br>
  &nbsp;
  &nbsp;
  &nbsp;
  &nbsp;
  <input class="form-check-input" type="checkbox" name="fourseesion" value="4 seessos/classes in a week" id="flexCheckDefault">
  <label class="form-check-label" for="flexCheckDefault">
  4 seessos/classes in a week
  </label>
  ...
  &nbsp;
  &nbsp;
  <input class="form-check-input" type="checkbox" name="fiveseesson" value="5 seessos/classes in a week" id="flexCheckDefault">
  <label class="form-check-label" for="flexCheckDefault">
  5 seessos/classes in a week
  </label>
